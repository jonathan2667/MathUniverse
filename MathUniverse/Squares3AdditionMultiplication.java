...
/**
 * Squares3AdditionMultiplication
 * 
 * Clasa care va fi reprezentata ca si casuta pentru raspunsuri.
 */
public class Squares3AdditionMultiplication extends EquationsAdditionMultiplication
{
    /**
     ...
     */
    public Squares3AdditionMultiplication (String key, String upImage, String downImage, String value, int position) {
        this.key = key;
