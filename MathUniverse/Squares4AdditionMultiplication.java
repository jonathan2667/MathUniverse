...
/**
 * Squares4AdditionMultiplication
 * 
 * Clasa care va fi reprezentata ca si casuta pentru raspunsuri.
 */
public class Squares4AdditionMultiplication extends EquationsAdditionMultiplication
{
    /**
     ...
     */
    public Squares4AdditionMultiplication ( String key, String upImage, String downImage, String value, int position) {
        this.key = key;
