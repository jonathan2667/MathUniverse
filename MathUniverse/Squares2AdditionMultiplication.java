...
/**
 * Squares2AdditionMultiplication
 * 
 * Clasa care va fi reprezentata ca si casuta pentru raspunsuri.
 */
public class Squares2AdditionMultiplication extends EquationsAdditionMultiplication
{
    /**
     ...
     */
    public Squares2AdditionMultiplication (String key, String upImage, String downImage, String value, int position) {
        this.key = key;
